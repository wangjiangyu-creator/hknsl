...
export const copy = {
  en: {
    ...
    footerCreatorNote: "This site is created by Professor Wang Jiangyu with Codex for his teaching and research purpose only.",
  ...
  "zh-cn": {
    ...
    shortName: "香港国安法门户",
    creatorNote: "This site is created by Professor Wang Jiangyu with Codex for his teaching and research purpose only.",
    footerCreatorNote: "本网站由王江雨教授用 Codex 创建，仅供其个人研究使用。",
